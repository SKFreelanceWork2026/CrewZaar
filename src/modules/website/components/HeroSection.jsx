...
const navigate = useNavigate();
  ...
  return (
    ...
    >
      {/* BACKGROUND IMAGES with synchronized fade transition */}
      ...
      {/* PREVIOUS BUTTON - Fixed position, never moves */}
      <IconButton
        onClick={handlePrev}
      ...
      {/* NEXT BUTTON - Fixed position, never moves */}
      <IconButton
        onClick={handleNext}
        disabled={isAnimating}
        sx={{
      ...
      >
        ...
        >
          {/* ANIMATED TEXT CONTAINER - syncs perfectly with carousel */}
          <Box
            key={current}
            sx={{
              animation: "slideText 0.8s cubic-bezier(0.25, 0.46, 0.45, 0.94)",
              "@keyframes slideText": {
                "0%": {
                  opacity: 0,
        ...
        {/* FIXED BUTTONS SECTION - Absolutely positioned to never move */}
        <Box
          sx={{
            position: "absolute",
            bottom: { xs: "28%", sm: "25%", md: "22%", lg: "20%" },
            left: "50%",
            transform: "translateX(-50%)",
            width: "100%",
            display: "flex",
...
>
  JOIN AS EMPLOYEE
        ...
        {/* WATCH DEMO - Fixed position section */}
        <Box
          sx={{
            position: "absolute",
            bottom: { xs: "12%", sm: "10%", md: "8%" },
            left: "50%",
            transform: "translateX(-50%)",
            display: "flex",
            alignItems: "center",
